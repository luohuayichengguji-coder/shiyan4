...
- 类别：SAM模型蒸馏 / SAM 轻量化 / 蒸馏
- 本地文件：`眼底视网膜病变分割-论文PDF/SAM模型蒸馏/2023_TinySAM_arXiv2312.13789.pdf`
- 页数：11；标识：arXiv:2312.13789
- 数据集线索：drive
- 指标线索：IoU; accuracy; dice; precision
...
- 页数：5；标识：arXiv:2501.16740
- 数据集线索：未抽取
- 指标线索：Dice; accuracy; map; precision
...
- 类别：SAM相关 / 通用 SAM / 高质量或快速分割
- 本地文件：`眼底视网膜病变分割-论文PDF/SAM相关/2023_FastSAM_arXiv2306.12156.pdf`
- 页数：11；标识：arXiv:2306.12156
- 数据集线索：未抽取
- 指标线索：AUC; IoU; Recall; accuracy; map; precision; recall

```text
Abstract The recently proposed segment anything model (SAM) has made a significant influence in many computer vision tasks. It is becoming a foundation step for many high-level tasks, like image segmentation, image caption, and image editing. However, its huge computation costs prevent it from wider applications in industry scenarios. The computation mainly comes from the Transformer architecture at highresolution inputs. In this paper, we propose a speed-up alternative method for this fundamental task with comparable performance. By reformulating the task as segmentsgeneration and prompting, we find that a regular CNN detector with an instance segmentation branch can also accomplish this task well. Specifically, we convert this task to the well-studied instance segmentation task and directly train the existing instance segmentation method using only 1/50 of the SA-1B dataset published by SAM authors. With our method, we achieve a comparable performance with the SAM method at 50× higher run-time speed. We give sufficient experimental results to demonstrate its effectiveness. The codes and demos will be released at https: //github.com/CASIA-IVA-Lab/FastSAM. 1.
```

## P08 HQ-SAM Segment Anything in High Quality

- 类别：SAM相关 / 通用 SAM / 高质量或快速分割
- 本地文件：`眼底视网膜病变分割-论文PDF/SAM相关/2023_HQ-SAM_Segment_Anything_in_High_Quality_arXiv2306.01567.pdf`
- 页数：21；标识：arXiv:2306.01567
- 数据集线索：未抽取
- 指标线索：FPS; IoU
...
- 页数：10；标识：arXiv:2304.12620
- 数据集线索：未抽取
- 指标线索：Dice; IoU; MAE; accuracy
...
## P12 Segment Anything Model for Medical Images?

- 类别：SAM相关 / 医学 SAM / 医学图像适配
- 本地文件：`眼底视网膜病变分割-论文PDF/SAM相关/2023_Segment_Anything_Model_for_Medical_Images_arXiv2304.14660.pdf`
- 页数：23；标识：arXiv:2304.14660
- 数据集线索：未抽取
- 指标线索：DICE; IOU

```text
Introduction The emergence of large language models such as ChatGPT1 and GPT-42 has sparked a new era in natural language processing (NLP), characterized by their remarkable zero-shot and few-shot generalization abilities. This progress has inspired researchers to develop similarly large-scale foundational models for computer vision (CV). The first proposed foundational CV models have been primarily based on pre-training
```
...
- 页数：30；标识：arXiv:2304.02643
- 数据集线索：未抽取
- 指标线索：IoU; MAE; dice; map; recall
...
- 类别：SAM相关 / 通用 SAM / 高质量或快速分割
- 本地文件：`眼底视网膜病变分割-论文PDF/SAM相关/2023_Semantic-SAM_arXiv2307.04767.pdf`
- 页数：14；标识：arXiv:2307.04767
- 数据集线索：未抽取
- 指标线索：IoU
...
## P22 A deep learning system for detecting diabetic retinopathy across the disease spectrum

- 类别：眼底视网膜病变分割 / 眼底病变检测 / 诊断关联
- 本地文件：`眼底视网膜病变分割-论文PDF/眼底视网膜病变分割/2021-nc-A deep learning system for detecting diabetic.pdf`
- 页数：11；标识：10.1038/s41467-021-23458-5
- 数据集线索：EyePACS
- 指标线索：AUC; IoU; Sensitivity; accuracy; sensitivity
...
- 页数：12；标识：arXiv:2201.11037
- 数据集线索：DDR; DRIVE; IDRiD; STARE
- 指标线索：AUC; accuracy; map; precision; recall
...
## P24 A deep learning system for predicting time to progression of diabetic retinopathy

- 类别：眼底视网膜病变分割 / 眼底病变检测 / 诊断关联
- 本地文件：`眼底视网膜病变分割-论文PDF/眼底视网膜病变分割/2023-nc-A deep learning system for predicting time t.pdf`
- 页数：27；标识：10.1038/s41591-023-02702-z
- 数据集线索：未抽取
- 指标线索：AUC; accuracy
